...
namespace Wpf
{
    public partial class NutriDoughnut
    {
        public NutriDoughnut()
        {
            InitializeComponent();
            ...
            SeriesCollection = new SeriesCollection
            {
                ...
                {
                    Title = "蔬菜",
                    Values = new ISeriesView<ObservableValue> { new ObservableValue(10) },
                    DataLabels = true
                },
                new PieSeries
                {
                    Title = "水果",
                    Values = new ISeriesView<ObservableValue> { new ObservableValue(4) },
                    DataLabels = true
                }
            };
        ...
        private void AddSeriesOnClick(object sender, RoutedEventArgs e)
        {
            ...
            var vals = new ISeriesView<ObservableValue>();

...
namespace Wpf
{
    ...
    public class DarkPanelControlVm : INotifyPropertyChanged
    {
        ...
        public DarkPanelControlVm()
        {
            ...
            Line1 = new ISeriesView<ObservableValue>
            {
            ...
            {
                new PieSeries {Title = "Yes",Values = new ISeriesView<ObservableValue> {Yes}},
                new PieSeries {Title = "No", Values = new ISeriesView<ObservableValue> {Maybe}},
                new PieSeries {Title = "Maybe", Values = new ISeriesView<ObservableValue> {Maybe}}
            };
            ...
            DynamicValues = new ISeriesView<ObservableValue>
            {
                new ObservableValue(1),
                new ObservableValue(5),
        ...
        public ISeriesView<ObservableValue> Line1 { get; set; }
        public ISeriesView<ObservableValue> DynamicValues { get; set; }
